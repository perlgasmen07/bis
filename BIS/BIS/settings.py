...
if not GOOGLE_OAUTH_CLIENT_ID:
    raise ValueError(
        ...
        'Have you put it in a file at the root of your project?'
    )
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-cpymjoihw(2_z#i(@#n2%+iu9#d9eb2*%shb9-^riq30@l&j!s')
